...
function convertMsgtoHtml(msg) {
	...
	for (var i = 0; i < count; i++) {
		...
		case webim.MSG_ELEMENT_TYPE.CUSTOM:
			...
			//转义，防XSS
			html += eleHtml //webim.Tool.formatText2Html(eleHtml);
			break;
...
function convertCustomMsgToHtml(content) {
	...
	//{"senderName":"测试1","receiverName":"测试2","packageid":2,"action":2,"packagetype":1}
	if (msg.action == 4) {
		return '<div style="display: flex;justify-content: flex-start;"><div><img style="width: 80px;height: 80px;" src="' +
			msg.image +
			'"/></div><div style="font-weight:bold;font-size: 13px;padding:5px 0px 5px 5px;display: flex;flex-direction: column;justify-content: space-between;"><div>' +
			msg.title +
		...
		return '<div style="display: flex;justify-content: flex-start;">' +
			'<div>' +
			'<img style="width: 80px;height: 80px;" src="http://opengiftfly-1255652370.file.myqcloud.com/img/201802/06/171444_9750.jpg" />' +
			'</div>' +
			'<div style="font-weight:bold;font-size: 13px;padding:5px 0px 5px 5px;display: flex;flex-direction: column;justify-content: space-between;">' +
			'<div>' +
			'<span>' +
			'订单编号：' + msg.orderNum +
			'</span>' +
	...
	return "data=" + data + ", desc=" + desc + ", ext=" + ext + "请联系技术人员";
}
//解析群提示消息元素
